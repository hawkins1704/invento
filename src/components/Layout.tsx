                            ...
                            {shiftMode === "open" ? (
                                ...
                                >
                                    <header className="space-y-2">
                                        ...
                                        <p className="text-sm text-slate-400">
                                            Confirma la sucursal y el efectivo
                                            inicial con el que arranca el turno.
                                        </p>
                                    </header>
                                ...
                                >
                                    <header className="space-y-2">
                                        ...
                                        <p className="text-sm text-slate-400">
                                            Revisa los importes y registra la
                                            caja real al finalizar el día.
                                        </p>
                                    </header>
                                    ...
                                    {activeShiftSummary ? (
                                        ...
                                        <div className="rounded-lg border border-slate-800 bg-slate-900/50 p-6 text-sm text-slate-300">
                                            ...
                                            sucursal. Selecciona otra sucursal o
                                            abre un turno para continuar.
                                        </div>
                                    )}
