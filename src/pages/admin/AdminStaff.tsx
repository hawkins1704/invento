...
const AdminStaff = () => {
        ...
        try {
            ...
            const message =
                error instanceof Error
                    ? error.message
                    : "No se pudo crear el miembro del personal. Inténtalo de nuevo.";
    ...
    return (
        <div className="space-y-8">
                    ...
                    <>
                        ...
                        {!branches || branches.length === 0 ? (
                            <span className="text-xs text-red-300">
                                Crea una sucursal antes de registrar personal.
                            </span>
                        ) : null}
                    </>
                }
            ...
            {isFormOpen && (
                <div
                    className={`fixed inset-0 z-50 flex items-center justify-center px-4 py-10 backdrop-blur ${isClosing ? "animate-[fadeOut_0.3s_ease-out]" : "animate-[fadeIn_0.2s_ease-out]"}`}
                >
                    <div
                        className={`absolute inset-0 bg-black/40 dark:bg-slate-950/70 ${isClosing ? "animate-[fadeOut_0.3s_ease-out]" : "animate-[fadeIn_0.2s_ease-out]"}`}
                    />
                    <div
                        className={`relative w-full max-w-2xl rounded-lg border border-slate-200 bg-white p-8 text-slate-900 shadow-2xl shadow-black/60 dark:border-slate-800 dark:bg-slate-900 dark:text-white ${isClosing ? "animate-[fadeOutScale_0.3s_ease-out]" : "animate-[fadeInScale_0.3s_ease-out]"}`}
                    >
